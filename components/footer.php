<footer class="footer">
   ...
   <section class="grid">
      ...
      <div class="box">
         ...
         <a href="https://www.hellosuman29@.com"><i class="fas fa-envelope"></i> suman@gmail.com</a>
         <a href="https://www.google.com/myplace"><i class="fas fa-map-marker-alt"></i> kovilpatti, india </a>
      </div>
   ...
   <div class="credit">&copy; copyright @ <?= date('Y'); ?> by <span>SUMAN</span> | all rights reserved!</div>
